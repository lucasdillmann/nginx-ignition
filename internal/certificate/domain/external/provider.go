...
import (
	...
	"github.com/lucasdillmann/nginx-ignition/internal/certificate/core/validator"
)
...
func (p *Provider) Issue(
	...
	if err := validator.Validate(ctx, request, &validationRules{fields}); err != nil {
		return nil, err
	}
...
func (p *Provider) Renew(
	...
	if err := validator.Validate(ctx, renewRequest, &validationRules{fields}); err != nil {
		return nil, err
	}
