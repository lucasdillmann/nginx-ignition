...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsIijdpfName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          tokenFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsIijdpfApiToken),
			Required:    true,
			Sensitive:   true,
		...
		},
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsIijdpfServiceCode),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          endpointFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsIijdpfApiEndpoint),
			Type:        dynamicfields.SingleLineTextType,
		},
	})
}
