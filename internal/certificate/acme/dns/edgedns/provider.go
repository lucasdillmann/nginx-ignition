...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsEdgednsName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          hostFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsEdgednsEdgegridHost),
			Required:    true,
		...
		},
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsEdgednsEdgegridClientToken,
			),
			Required:  true,
			Sensitive: true,
			Type:      dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsEdgednsEdgegridClientSecret,
			),
			Required:  true,
			Sensitive: true,
			Type:      dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsEdgednsEdgegridAccessToken,
			),
			Required:  true,
			Sensitive: true,
			Type:      dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsEdgednsEdgegridAccountKey,
			),
			Required: true,
			Type:     dynamicfields.SingleLineTextType,
		},
