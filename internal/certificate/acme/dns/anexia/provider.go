...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsAnexiaName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          tokenFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsAnexiaToken),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          apiURLFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsAnexiaApiUrl),
			Required:    false,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
