...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsDerakName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          apiKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsDerakApiKey),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          websiteIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsDerakWebsiteId),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
