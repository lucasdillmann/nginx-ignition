...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsYandexcloudName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          iamTokenFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsYandexcloudIamToken),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          folderIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsYandexcloudFolderId),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
