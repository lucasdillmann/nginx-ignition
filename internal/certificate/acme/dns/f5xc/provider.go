...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsF5xcName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          apiTokenFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsF5xcApiToken),
			Required:    true,
			Sensitive:   true,
		...
		},
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsF5xcTenantName),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          groupNameFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsF5xcGroupName),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
