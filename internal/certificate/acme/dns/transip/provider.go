...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsTransipName)
}
	...
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsTransipAccountName),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          privateKeyPathFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsTransipPrivateKeyPath),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
