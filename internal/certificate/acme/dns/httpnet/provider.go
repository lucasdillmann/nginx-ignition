...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsHttpnetName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          apiKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsHttpnetApiKey),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          zoneNameFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsHttpnetZoneName),
			Type:        dynamicfields.SingleLineTextType,
		},
	})
}
