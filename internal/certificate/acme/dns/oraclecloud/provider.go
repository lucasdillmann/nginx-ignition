...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsOraclecloudName)
}
	...
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsOraclecloudCompartmentOcid,
			),
			Required: true,
		...
		{
			ID:          regionFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOraclecloudRegion),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          tenancyOCIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOraclecloudTenancyOcid),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          userOCIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOraclecloudUserOcid),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsOraclecloudPublicKeyFingerprint,
			),
			Required: true,
			Type:     dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOraclecloudPrivateKey),
			HelpText: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsOraclecloudPrivateKeyHelp,
			),
			Required:  true,
			Sensitive: true,
		...
		},
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsOraclecloudPrivateKeyPassphrase,
			),
			Sensitive: true,
			Type:      dynamicfields.SingleLineTextType,
		},
