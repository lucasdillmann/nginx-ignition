...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsVercelName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          tokenFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsVercelToken),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          teamFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsVercelTeamId),
			Type:        dynamicfields.SingleLineTextType,
		},
	})
}
