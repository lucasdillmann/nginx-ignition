...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsEuservName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          emailFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsEuservEmail),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          passwordFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsEuservPassword),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          orderIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsEuservOrderId),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
