...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsGnameName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          appIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsGnameAppId),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          appKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsGnameAppKey),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
