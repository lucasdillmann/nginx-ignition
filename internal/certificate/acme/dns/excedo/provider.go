...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsExcedoName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          apiKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsExcedoApiKey),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          apiURLFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsExcedoApiUrl),
			Required:    false,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
