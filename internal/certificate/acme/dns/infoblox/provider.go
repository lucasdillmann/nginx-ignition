...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsInfobloxName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          hostFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsInfobloxGridManagerHost),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          portFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsInfobloxGridManagerPort),
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          usernameFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsInfobloxUsername),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          passwordFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsInfobloxPassword),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          dnsViewFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsInfobloxDnsView),
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          wapiVersionFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsInfobloxWapiVersion),
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          sslVerifyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsInfobloxVerifySsl),
		...
		},
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsInfobloxCaCertificatePath,
			),
			Type: dynamicfields.SingleLineTextType,
		},
	})
