...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsHyperoneName)
}
	...
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsHyperoneApiEndpoint),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          locationIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsHyperoneLocationId),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsHyperonePassportFileLocation,
			),
			Required: true,
			Type:     dynamicfields.SingleLineTextType,
		},
