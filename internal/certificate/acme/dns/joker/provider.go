...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsJokerName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:           apiModeFieldID,
			Description:  i18n.M(ctx, i18n.K.CertificateAcmeDnsJokerApiMode),
		...
		{
			ID:          apiKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsJokerApiKey),
			Sensitive:   true,
			Required:    true,
		...
		{
			ID:          usernameFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsJokerUsername),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
			Conditions: []dynamicfields.Condition{{
				ParentField: apiModeFieldID,
		...
		{
			ID:          passwordFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsJokerPassword),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
			Conditions: []dynamicfields.Condition{{
