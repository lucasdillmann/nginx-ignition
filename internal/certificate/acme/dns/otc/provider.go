...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsOtcName)
}
	...
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOtcDomainName),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          projectNameFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOtcProjectName),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          userNameFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOtcUsername),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          passwordFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOtcPassword),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOtcIdentityEndpoint),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
