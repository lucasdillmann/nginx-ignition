...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsLightsailName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          dnsZoneFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsLightsailDnsZoneName),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          regionFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsLightsailAwsRegion),
			HelpText:    i18n.M(ctx, i18n.K.CertificateAcmeDnsLightsailAwsRegionHelp),
			Type:        dynamicfields.SingleLineTextType,
		},
	})
}
