...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsDnsmadeeasyName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          apiKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsDnsmadeeasyApiKey),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          secretKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsDnsmadeeasySecretKey),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
