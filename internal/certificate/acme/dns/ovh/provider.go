...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsOvhName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          endpointFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOvhApiEndpoint),
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          applicationKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOvhApplicationKey),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          applicationSecFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOvhApplicationSecret),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsOvhConsumerKey),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
