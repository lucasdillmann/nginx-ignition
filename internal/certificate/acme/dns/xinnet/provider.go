...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsXinnetName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          secretFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsXinnetSecret),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          agentIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsXinnetAgentId),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
