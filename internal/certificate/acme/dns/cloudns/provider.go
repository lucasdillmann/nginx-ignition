...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsCloudnsName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          authIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsCloudnsAuthId),
			Required:    true,
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          subAuthIDFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsCloudnsSubAuthId),
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          passwordFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsCloudnsPassword),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
