...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsAlwaysdataName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          apiKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsAlwaysdataApiKey),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          accountFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsAlwaysdataAccount),
			Required:    false,
			Type:        dynamicfields.SingleLineTextType,
		},
	})
