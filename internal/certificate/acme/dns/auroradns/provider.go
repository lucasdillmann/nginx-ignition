...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsAuroradnsName)
}
...
func (p *Provider) DynamicFields(ctx context.Context) []dynamicfields.DynamicField {
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			ID:          apiKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsAuroradnsApiKey),
			Required:    true,
			Sensitive:   true,
		...
		{
			ID:          secretFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsAuroradnsSecret),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
