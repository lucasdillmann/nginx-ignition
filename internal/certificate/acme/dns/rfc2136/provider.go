...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateAcmeDnsRfc2136Name)
}
	...
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			...
			Description: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsRfc2136NameserverAddress,
			),
			HelpText: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsRfc2136NameserverAddressHelp,
			),
			Required: true,
		...
		{
			ID:          tsigKeyFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsRfc2136TsigKeyName),
			HelpText:    i18n.M(ctx, i18n.K.CertificateAcmeDnsRfc2136TsigKeyNameHelp),
			Type:        dynamicfields.SingleLineTextType,
		},
		{
			ID:          tsigSecretFieldID,
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsRfc2136TsigSecretKey),
			HelpText: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsRfc2136TsigSecretKeyHelp,
			),
			Sensitive: true,
			Type:      dynamicfields.SingleLineTextType,
		},
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateAcmeDnsRfc2136TsigAlgorithm),
			HelpText: i18n.M(
				ctx,
				i18n.K.CertificateAcmeDnsRfc2136TsigAlgorithmHelp,
			),
			Type: dynamicfields.SingleLineTextType,
		},
	})
