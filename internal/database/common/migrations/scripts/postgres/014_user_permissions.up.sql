...
alter table "user" alter column hosts_access_level drop default;
alter table "user" alter column streams_access_level drop default;
alter table "user" alter column certificates_access_level drop default;
alter table "user" alter column settings_access_level drop default;
alter table "user" alter column users_access_level drop default;
alter table "user" alter column logs_access_level drop default;
alter table "user" alter column integrations_access_level drop default;
alter table "user" alter column access_lists_access_level drop default;
alter table "user" alter column nginx_server_access_level drop default;
