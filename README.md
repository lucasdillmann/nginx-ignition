...
nginx ignition is available as a Docker image and can be run locally on a Linux, macOS or Windows machine. 
...
### Installing or running locally on a Linux, macOS or Windows machine
...
inside the zip that will guide you through the installation process for Linux, macOS or Windows.
