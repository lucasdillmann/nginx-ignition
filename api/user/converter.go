...
func toDomain(dto *userRequestDto) *user.SaveRequest {
	return &user.SaveRequest{
		...
		Permissions: user.Permissions{
			...
			ServerCertificates: user.AccessLevel(*dto.Permissions.ServerCertificates),
			ClientCertificates: user.AccessLevel(*dto.Permissions.ClientCertificates),
...
func toDto(domain *user.User) *userResponseDto {
	return &userResponseDto{
		...
		Permissions: userPermissionsDto{
			...
			ServerCertificates: ptr.Of(string(domain.Permissions.ServerCertificates)),
			ClientCertificates: ptr.Of(string(domain.Permissions.ClientCertificates)),
