...
func (p *Provider) Name(ctx context.Context) *i18n.Message {
	return i18n.M(ctx, i18n.K.CertificateCommonLetsEncryptDnsSakuracloudName)
}
	...
	return dns.LinkedToProvider(p.ID(), []dynamicfields.DynamicField{
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateCommonLetsEncryptDnsSakuracloudAccessToken),
			Required:    true,
			Sensitive:   true,
		...
		},
		{
			...
			Description: i18n.M(ctx, i18n.K.CertificateCommonLetsEncryptDnsSakuracloudAccessSecret),
			Required:    true,
			Sensitive:   true,
			Type:        dynamicfields.SingleLineTextType,
		},
