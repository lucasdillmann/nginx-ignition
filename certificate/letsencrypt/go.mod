...
require (
	...
	github.com/baidubce/bce-sdk-go v0.9.262 // indirect
	...
	github.com/yandex-cloud/go-sdk/services/dns v0.0.44 // indirect
	github.com/yandex-cloud/go-sdk/v2 v2.72.0 // indirect
