...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.3.46 // indirect
	...
	github.com/yandex-cloud/go-sdk/services/dns v0.0.33 // indirect
	github.com/yandex-cloud/go-sdk/v2 v2.51.0 // indirect
