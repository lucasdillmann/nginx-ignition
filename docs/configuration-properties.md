...
| NGINX_IGNITION_SERVER_READ_TIMEOUT_SECONDS               | Maximum duration in seconds for reading the entire request, including the body                        | 30           | 15                                                                            |
| NGINX_IGNITION_SERVER_WRITE_TIMEOUT_SECONDS              | Maximum duration in secods for writing the response                                                   | 60           | 30                                                                            |
| NGINX_IGNITION_SERVER_IDLE_TIMEOUT_SECONDS               | Maximum amount of seconds to wait for the next request when keep-alives are enabled                   | 120          | 120                                                                           |
| NGINX_IGNITION_SERVER_READ_HEADER_TIMEOUT_SECONDS        | Maximum duration in seconds for reading request headers                                               | 5            | 2                                                                             |
| NGINX_IGNITION_SERVER_MAX_HEADER_BYTES                   | Maximum size of request headers in bytes                                                              | 524288       | 16384                                                                         |
| NGINX_IGNITION_SERVER_MAX_BODY_BYTES                     | Maximum size of request body in bytes                                                                 | 5242880      | 10485760                                                                      |
