...
func toDomain(model *userModel) *user.User {
	return &user.User{
		...
		Permissions: user.Permissions{
			...
			ServerCertificates: user.AccessLevel(model.ServerCertificatesAccessLevel),
			ClientCertificates: user.AccessLevel(model.ClientCertificatesAccessLevel),
...
func toModel(domain *user.User) *userModel {
	return &userModel{
		...
		ServerCertificatesAccessLevel: string(domain.Permissions.ServerCertificates),
		ClientCertificatesAccessLevel: string(domain.Permissions.ClientCertificates),
