...
import { Alert, Flex, Form, FormInstance, Input, InputNumber, Select, Space, Switch, Tabs } from "antd"
                    ...
                    <>
                        <Flex className="cache-form-inner-flex-container">
                            ...
                            <Flex className="cache-form-inner-flex-container-column cache-form-expanded-label-size">
                                ...
                                <p className="cache-form-section-help-text">
                                    Define which requests should be cached and how.
                                </p>
                                <Form.Item
                                    name="allowedMethods"
                        ...
                        <p className="cache-form-section-help-text">
                            Define how the cache should behave when the content is stale and how nginx should handle revalidation.
                        </p>
                        <Form.Item
                            name="useStale"
                ...
                children: (
                    <>
                        <Alert
                            ...
                            description={`
                                These settings can break your nginx server or make it misbehave. 
                                The rules will be placed as-is in the nginx configuration.
                            `}
                            type="warning"
                        ...
                        <p className="cache-form-section-help-text">
                            Settings to prevent multiple simultaneous requests from populating the cache at the same
                            time.
                        </p>
                        <Form.Item
                        ...
                        <p className="cache-form-section-help-text">
                            Rules to determine when to bypass or not store the cache.
                        </p>
                        <Flex className="cache-form-inner-flex-container">
                            <Flex className="cache-form-inner-flex-container-column">
                                <h3 className="cache-form-section-name" style={{ fontSize: 16, marginTop: 20 }}>
                                    Bypass rules
                                </h3>
                                <p className="cache-form-section-help-text" style={{ marginBottom: 10 }}>
