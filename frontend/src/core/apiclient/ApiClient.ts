...
export default class ApiClient {
    ...
    async get<T>(
        ...
        return await this.executeRequest(fullPath, request, raw)
    }
    ...
    private async executeRequest<T>(path: string, request: RequestInit, raw: boolean = false): Promise<ApiResponse<T>> {
